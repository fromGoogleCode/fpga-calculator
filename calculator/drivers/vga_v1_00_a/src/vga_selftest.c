/*****************************************************************************
* Filename:          G:\Sandboxes\Xilinx\calculator/drivers/vga_v1_00_a/src/vga_selftest.c
* Version:           1.00.a
* Description:       Contains a diagnostic self-test function for the vga driver
...
XStatus VGA_SelfTest(void * baseaddr_p)
{
  ...
  {
    VGA_mWriteMemory(LocalBRAM+4*Index, 0xDEADBEEF);
    Mem32Value = VGA_mReadMemory(LocalBRAM+4*Index);
